                ...
                <footer id="footer" class="pagewidth clearfix" itemscope="itemscope" itemtype="https://schema.org/WPFooter">
                    ...
                    <div class="footer-text clearfix">
                        <div class="footer-text-inner">
                            <div class="one">Copyright © 2018 Nicky Arthur Fitness. All Rights Reserved.</div>																														</div>
                    </div>
                    <!-- /.footer-text -->
        ...
        <!-- SCHEMA BEGIN --><script type="application/ld+json">[{"@context":"https:\/\/schema.org","@type":"WebSite","url":"<?php echo get_site_url(); ?>\/","potentialAction":{"@type":"SearchAction","target":"<?php echo get_site_url(); ?>\/?&s={search_term_string}","query-input":"required name=search_term_string"}},{"@context":"https:\/\/schema.org","@type":"WebPage","mainEntityOfPage":{"@type":"WebPage","@id":"<?php echo get_site_url(); ?>\/"},"headline":"Home","datePublished":"2016-12-28T04:51:33+00:00","dateModified":"2016-12-28T04:51:33+00:00","description":"","commentCount":"0"}]</script><!-- /SCHEMA END -->		<!-- wp_footer -->
        <script>
            jQuery(function() {
            var gaProperty = '';
