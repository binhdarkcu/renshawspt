...
?>
	...
	<p style="margin-left:12px;">
		<a class="mm-ui-button" onclick="mmjs.downloadTemplate('<?php echo MM_MODULES_URL; ?>','<?php echo MM_EXPORT_FILE_MEMBERS_IMPORT_TEMPLATE; ?>');"><?php echo MM_Utils::getIcon('download', '', '1.3em', '2px'); ?> Download Import Template</a>
