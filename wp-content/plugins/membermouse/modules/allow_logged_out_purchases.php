...
<div class="mm-wrap">
    <p class="mm-header-text">Allow Logged Out Purchases <span style="font-size:12px;"><a href="http://support.membermouse.com/support/solutions/articles/9000020383-allow-logged-out-members-to-make-purchases" target="_blank">Learn more</a></span></p>
    ...
    to make a purchase using an email address and valid password associated with an existing account that the purchase should be associated 
    with the existing account. If the option below is unchecked, an error will be displayed to the user indicating that an account already 
    exists with that email address and they'll need to log in to make a purchase associated with that email address.</div>
