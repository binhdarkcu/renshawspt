...
<div class="mm-wrap">
	...
	<div style="margin-top:10px;">
		...
		Allow members with overdue memberships or bundles to access protected content <a href="http://support.membermouse.com/support/solutions/articles/9000020507-configure-access-to-content-when-status-is-overdue" target="_blank">Learn more</a>
	...
	<p>Content that is dripped to members becomes available at 12 AM. Based on the setting below this will happen at 12 AM server time or 
	12 AM local time. Local time is based on the current WordPress timezone setting of <code><?php echo MM_OptionUtils::getOption("timezone_string"); ?></code>. 
	You can change this setting on <em>WordPress Settings > General > Timezone</em>.<br/><br/>Would you like content to be dripped at 12 AM server time or local time?</p>
		<div>
			...
			Use server time where it's currently <code><?php echo MM_Utils::getCurrentTime("Y-m-d g:i a"); ?></code>
		</div>
		<div style="margin-top:10px;">
			...
			Use local time where it's currently <code><?php echo MM_Utils::dateToLocal(MM_Utils::getCurrentTime(), "Y-m-d g:i a"); ?></code>
		</div>
