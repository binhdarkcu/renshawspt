	    ...
	    <div style='width:650px'>
			...
			<table width='750px'>
				<tr>
					...
					<td>
						Activate the MemberMouse <?php echo $testService->getName(); ?>
					</td>
				</tr>
				<tr>
					<td colspan='2'>
			...
			<?php echo MM_Utils::getIcon('warning', 'red', '1.3em', '2px'); ?> <em>Currently the test payment service is enabled and configured to always 
			...
			<a href="http://support.membermouse.com/support/solutions/articles/9000020182-securing-your-site-with-https" target="_blank">steps you can take to secure your site</a>.</em>
			</p>
			<table width='750px'>
